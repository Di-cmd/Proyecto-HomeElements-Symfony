 ...
 */
final class Version20220910151834 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE producto (id INT AUTO_INCREMENT NOT NULL, categoria_id INT DEFAULT NULL, pedido_id INT DEFAULT NULL, nombre VARCHAR(255) NOT NULL, codigo VARCHAR(255) NOT NULL, cantidad VARCHAR(255) NOT NULL, precio VARCHAR(255) NOT NULL, INDEX IDX_A7BB06153397707A (categoria_id), INDEX IDX_A7BB06154854653A (pedido_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
